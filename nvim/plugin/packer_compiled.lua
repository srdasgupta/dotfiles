...
_G.packer_plugins = {
  ...
  ["deoplete.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/opt/deoplete.nvim",
  ...
  ["git-worktree.nvim"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/git-worktree.nvim",
  ...
  neotest = {
    after = { "neotest-python", "neotest-jest", "neotest-vim-test", "neotest-rust", "neotest-go", "neotest-plenary", "vim-test" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "friendly-snippets", "lspkind-nvim", "cmp-nvim-lsp", "cmp-rg", "cmp-path", "cmp-nvim-lua", "cmp-conventionalcommits", "cmp-cmdline", "cmp-treesitter", "cmp-buffer", "tabout.nvim", "LuaSnip", "vim-snippets", "cmp-nvim-lsp-signature-help" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-python", "nvim-dap-ui", "one-small-step-for-vimkind", "nvim-dap-go", "nvim-dap-virtual-text" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lua-dev.nvim", "vim-illuminate", "null-ls.nvim", "schemastore.nvim", "nvim-navic", "inlay-hints.nvim", "typescript.nvim", "mason-tool-installer.nvim", "fidget.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treehopper", "nvim-treesitter-textobjects", "nvim-treesitter-textsubjects", "lualine.nvim", "playground", "nvim-ts-rainbow", "nvim-ts-context-commentstring", "nvim-treesitter-context", "hlargs.nvim", "spellsitter.nvim" },
  ...
  ["nvim-treesitter-context"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/opt/nvim-treesitter-context",
  ...
  ["telescope.nvim"] = {
    after = { "telescope-zoxide", "cder.nvim", "telescope-bookmarks.nvim", "telescope-github.nvim", "telescope-media-files.nvim", "telescope-smart-history.nvim", "telescope-project.nvim", "telescope-fzf-native.nvim", "telescope-symbols.nvim", "popup.nvim", "telescope-repo.nvim", "telescope-file-browser.nvim", "project.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "nvim-neoclip.lua", "telescope-arecibo.nvim" },
    commands = { "Telescope" },
  ...
  ["true-zen.nvim"] = {
    ...
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/true-zen.nvim",
    url = "https://github.com/Pocco81/true-zen.nvim"
  },
  ["twilight.nvim"] = {
    config = { "\27LJ\2\n=\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\rtwilight\17config.focus\frequire\0" },
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/twilight.nvim",
  ...
  ["zen-mode.nvim"] = {
    config = { "\27LJ\2\n8\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\bzen\17config.focus\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\n8\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\bzen\17config.focus\frequire\0", "config", "zen-mode.nvim")
...
try_loadstring("\27LJ\2\n=\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\rtwilight\17config.focus\frequire\0", "config", "twilight.nvim")
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file UpdateRemotePlugins lua require("packer.load")({'deoplete.nvim'}, { cmd = "UpdateRemotePlugins", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'FixCursorHold.nvim', 'nvim-treesitter-textobjects', 'vim-surround', 'vim-searchindex', 'vim-scriptease', 'nvim-lspconfig', 'nvim-bufferline.lua', 'nvim-treesitter-textsubjects', 'dressing.nvim', 'readline.nvim', 'vim-visual-multi', 'lualine.nvim', 'marks.nvim', 'open-browser.vim', 'luv-vimdocs', 'nvim-ts-rainbow', 'nvim-ts-context-commentstring', 'nvim-treesitter', 'nvim-treesitter-context', 'nvim-pqf', 'nvim-notify', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-luaref', 'vim-vinegar'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'better-escape.nvim', 'nvim-autopairs', 'nvim-treesitter-endwise', 'nvim-cmp', 'nvim-ts-autotag'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
