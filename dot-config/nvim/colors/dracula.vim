...
exe "let s:fg_blueviolet = ' ".s:vmode."fg=".s:blueviolet."'"
exe "let s:fg_rosybrown  = ' ".s:vmode."fg=".s:rosybrown ."'"
exe "let s:fg_mistyrose  = ' ".s:vmode."fg=".s:mistyrose ."'"
...
exe "hi! VertSplit"       .s:fg_window      .s:bg_purple      .s:fmt_none
...
" C functions
exe "hi cCustomFunc"                    .s:fg_green        .s:bg_none          .s:fmt_none
exe "hi cCustomClass"                   .s:fg_purple       .s:bg_none          .s:fmt_none
