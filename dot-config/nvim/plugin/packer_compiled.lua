...
_G.packer_plugins = {
  ...
  ["github-notifications.nvim"] = {
    loaded = true,
    path = "/Users/apple/.local/share/nvim/site/pack/packer/start/github-notifications.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lua", "cmp-cmdline", "cmp-treesitter", "cmp-buffer", "LuaSnip", "lspkind-nvim", "tabout.nvim", "friendly-snippets", "vim-snippets", "cmp-conventionalcommits", "cmp-nvim-lsp-signature-help", "cmp-rg" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-go", "nvim-dap-virtual-text", "nvim-dap-python", "one-small-step-for-vimkind", "nvim-dap-ui" },
  ...
  ["nvim-lspconfig"] = {
    after = { "mason-tool-installer.nvim", "vim-illuminate", "inlay-hints.nvim", "schemastore.nvim", "typescript.nvim", "fidget.nvim", "nvim-navic", "lua-dev.nvim", "null-ls.nvim" },
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treehopper", "playground", "nvim-treesitter-context", "lualine.nvim", "hlargs.nvim", "nvim-treesitter-textsubjects", "spellsitter.nvim", "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-rainbow" },
  ...
  ["telescope.nvim"] = {
    after = { "popup.nvim", "telescope-fzf-native.nvim", "telescope-project.nvim", "telescope-repo.nvim", "telescope-file-browser.nvim", "project.nvim", "telescope-dap.nvim", "telescope-frecency.nvim", "nvim-neoclip.lua", "telescope-smart-history.nvim", "telescope-arecibo.nvim", "telescope-media-files.nvim", "telescope-github.nvim", "telescope-zoxide", "cder.nvim", "telescope-bookmarks.nvim", "telescope-symbols.nvim" },
    commands = { "Telescope" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'readline.nvim', 'vim-visual-multi', 'vim-vinegar', 'vim-surround', 'vim-searchindex', 'nvim-treesitter-context', 'lualine.nvim', 'open-browser.vim', 'nvim-treesitter-textsubjects', 'nvim-luaref', 'dressing.nvim', 'nvim-treesitter-textobjects', 'nvim-ts-context-commentstring', 'nvim-treesitter', 'luv-vimdocs', 'nvim-bufferline.lua', 'nvim-lspconfig', 'nvim-notify', 'nvim-ts-rainbow', 'marks.nvim', 'FixCursorHold.nvim', 'indent-blankline.nvim', 'gitsigns.nvim', 'nvim-pqf', 'vim-scriptease'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-endwise', 'better-escape.nvim', 'nvim-cmp', 'nvim-ts-autotag', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
